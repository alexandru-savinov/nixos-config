...
class TestGenerateAPKG:
    ...
    def test_unicode_content(self):
        ...
        input_data = {
            ...
            "cards": [
                {"word": "café", "description": "Coffee shop"},
                {"word": "日本語", "description": "Japanese language"},
                {"word": "emoji 🎉", "description": "Party celebration"}
            ]
        }
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1 and sys.argv[1] == "--test":
        ...
        try:
            ...
            if result["success"]:
                validation = validate_apkg_file(result["apkgPath"])
                print(f"✓ APKG validation: valid={validation['valid']}")
