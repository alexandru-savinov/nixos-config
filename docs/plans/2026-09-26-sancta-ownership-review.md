...
- Local regression suite: 59 tests, 58 passed and one optional real-zmx test skipped. Includes a real disposable fake-agent process proving lock contention, lifetime, release and exit status. This does not establish native PTY or human UI acceptance.
